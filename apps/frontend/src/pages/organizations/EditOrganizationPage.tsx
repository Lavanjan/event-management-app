...
import { organizationService, Organization, UpdateOrganizationRequest } from '../../services/organizationService';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.slug !== organization.slug) {
        const isSlugAvailable = await organizationService.validateSlug(formData.slug!, organization.id);
        if (!isSlugAvailable) {
      ...
      navigate(`/organizations/${updatedOrg.id}`);
    } catch (error: any) {
