...
# ==============================================
# Event Booking System - Production Deployment Script
# ==============================================
...
backup_database() {
    ...
    docker-compose -f docker-compose.prod.yml exec postgres pg_dump -U postgres event_booking > "$backup_file"
...
# Show help
show_help() {
    echo "Event Booking System - Deployment Script"
    echo ""
